...
@section('body')
    <div class="main">
        ...
        <div class="mainbody">
            ...
            <div class="body">
                <form class="formForDrug" action="{{ route('message.update', [App::getLocale(), $message->id]) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    <div class="formTitle">
                    ...
                    <div class="inputGp">
                        ...
                        <input type="text" name="msg_content" placeholder="e.g: Tomorrow meeting at 1:30 pm"
